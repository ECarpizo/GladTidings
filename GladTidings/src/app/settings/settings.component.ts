...
export class SettingsComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private postService: PostService, private userService: UserService, private categoryService: CategoryService) {
  }
  ...
  createPost() {
    ...
    this.postService.createPost(formValue).subscribe(data => {console.log(data)});
  }
}
